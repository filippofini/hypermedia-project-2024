<template>
  <div>
    ...
    <div class="prev-next">
      <NuxtLink :to="'/projects/' + previousLink" aria-label="link to previous project" class="link">Previous</NuxtLink>
      <NuxtLink :to="'/projects/' + nextLink" aria-label="link to next project" class="link">Next</NuxtLink>
    </div>
  </div>
  ...
  <div class="third-band">
    ...
    <div class="recommendation">
      <ProjectCard v-for="id in suggestedProjects" :key="id" :small_desc="findProjectById(id).small_desc" :title="findProjectById(id).title" :id="id" :link="'/projects/' + id" :year="findProjectById(id).year" :image="findProjectById(id).image" />
    </div>
  </div>
</template>
